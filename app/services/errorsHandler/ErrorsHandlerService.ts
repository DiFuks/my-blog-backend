...
import { UnhandledRemoteError } from '@services/errorsHandler/defaultHandlers/UnhandledRemoteError';
...
export class ErrorsHandlerService {
    ...
    constructor(
        ...
        @inject(typesServices.ErrorsHandlerDefaultUnhandledRemoteError) unhandledRemoteError: UnhandledRemoteError,
    ...
    public async handle(err: any, req: Request, res: Response): Promise<void> {
        ...
        if (err.name === 'SystemError') {
            ...
            await this.unhandledRemoteError.handle(err as AxiosError);
